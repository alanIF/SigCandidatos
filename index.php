    ...
    <div class="row justify-content-center">
      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Bem Vindo ao Sig Candidatos!</h1>
                  </div>
                    ...
                    <button type="submit"  name='botao' class="btn btn-primary btn-user btn-block">
                      Login
                    </button>
                    <hr>
        ...
        ?>
                  ...
                  <div class="text-center">
                    <a class="btn btn-primary btn-user btn-block" href="register.php">Criar Conta</a>
                  </div>
                </div>
              </div>
            </div>
